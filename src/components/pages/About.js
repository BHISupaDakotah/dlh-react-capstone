...
FE Capstone:
Requirements-
Render a dashboard w/ cards for widgets.[x]
MUST HAVE WIDGETS: 
 - Weather widget that fetch's from an api[x]
 - Swapi Query Widget -should be able to search swapi through your app and display information retrieved[x]
...
Login through custom api https://devpipeline-mock-api.herokuapp.com. A fallback could be  https://httpbin.org/post [x]
Logout [x]
